...
class DiskConsumption : Parcelable {
    ...
    override fun hashCode(): Int {
        var result = consumedBytes.hashCode()
        result = 31 * result + availableBytes.hashCode()
        return result
    }
    ...
    companion object {
        ...
        @Suppress("unused")
        @JvmField
        val CREATOR: Parcelable.Creator<DiskConsumption?> =
            object : Parcelable.Creator<DiskConsumption?> {
        ...
        private fun bytesAvailable(): Long {
            ...
            Log.v(TAG, "Space available: $mbAvailable MB")
